...
function Dashboard() {
    ...
    const viewProducts = async () => {
        try {
            const response = await axios.get('https://backend-vq0u.onrender.com/viewProducts');
    ...
    const deleteProduct = async (id) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://backend-vq0u.onrender.com/deleteProduct/${id}`);
    ...
    return (
        <div  className="w-full flex justify-center">
            <div >
                ...
                <thead>
                    <tr className="bg-blue-400 border border-gray-400 font-bold">
